...
public class JsonUtils {
    ...
    public static String getStringVal(JsonNode root, String keyPath) {
        return getVal(root, keyPath).asText("");
    }
    ...
    public static void removeKey(JsonNode root, String keyPath) {
        if (root == null || keyPath == null || "".equals(keyPath))
            return;
    ...
    public static String formatObjectToJsonString(Object request) {
